...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card bg-dark text-white p-4 mb-4">
        <div class="row">
            ...
            <!-- Botón Asignar -->
            <div class="col-md-4 mb-3">
                <label class="form-label">&nbsp;</label> <!-- Espacio para alineación -->
                <asp:Button ID="btnAsignar" runat="server" Text="Asignar"
                    CssClass="btn btn-success w-100" OnClick="btnAsignar_Click" />
            </div>
        </div>

        <!-- Mensaje -->
        <asp:Label ID="lblMensaje" runat="server"
            CssClass="d-block mt-2 text-success"></asp:Label>
    </div>
